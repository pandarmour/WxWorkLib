...
{
    public class SendMessageBaseModel
    {
        /// <summary>
    ...
    /// 文本消息
    /// </summary>
    public class SendMessageTextModel : SendMessageBaseModel
    {
        public SendMessageTextModel()
        {
            MsgType = "text";
        }
    ...
    /// 图片消息
    /// </summary>
    public class SendMessageImageModel : SendMessageBaseModel
    {
        public SendMessageImageModel()
        {
            MsgType = "image";
        }
    ...
    /// 语音消息
    /// </summary>
    public class SendMessageVoiceModel : SendMessageBaseModel
    {
        public SendMessageVoiceModel()
        {
            MsgType = "voice";
        }
    ...
    /// 视频消息
    /// </summary>
    public class SendMessageVideoModel : SendMessageBaseModel
    {
        public SendMessageVideoModel()
        {
            MsgType = "video";
        }
    ...
    /// 文件消息
    /// </summary>
    public class SendMessageFileModel : SendMessageBaseModel
    {
        public SendMessageFileModel()
        {
            MsgType = "file";
        }
    ...
    /// 文本卡片消息
    /// </summary>
    public class SendMessageTextCardModel : SendMessageBaseModel
    {
        public SendMessageTextCardModel()
        {
            MsgType = "textcard";
        }
    ...
    /// 图文消息
    /// </summary>
    public class SendMessageNewsModel : SendMessageBaseModel
    {
        public SendMessageNewsModel()
        {
            MsgType = "news";
        }
    ...
    /// 图文消息（mpnews）
    /// </summary>
    public class SendMessageMPNewsModel : SendMessageBaseModel
    {
        public SendMessageMPNewsModel()
        {
            MsgType = "mpnews";
        }
    ...
    /// markdown消息
    /// </summary>
    public class SendMessageMarkdownModel : SendMessageBaseModel
    {
        public SendMessageMarkdownModel()
        {
            MsgType = "markdown";
        }
    ...
    /// 小程序通知消息
    /// </summary>
    public class SendMessageMiniProgramNoticeModel : SendMessageBaseModel
    {
        public SendMessageMiniProgramNoticeModel()
        {
    ...
    /// 任务卡片消息
    /// </summary>
    public class SendMessageTaskCardModel : SendMessageBaseModel
    {
        public SendMessageTaskCardModel()
        {
            MsgType = "taskcard";
        }
